...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MODF] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SLEP, KC_VOLU, _______,
        RESET,   EEP_RST, _______,                   _______, _______, _______,                   _______, DIAL_LI, KC_BRID, KC_VOLD, KC_BRIU
    )
};
